                    ...
                    <div className="px-6 py-6 lg:px-8">
                        ...
                        <form className="space-y-6" action="#">
                            ...
                            <button
                                ...
                                type="submit"
                                onClick={AddNewList}
                                className={`flex items-center justify-center gap-4 tracking-wider uppercase w-full text-white bg-gray-900 hover:bg-gray-900 ${!listName && 'opacity-50'} focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800`}>
                                <svg class="w-6 h-6 text-yellow-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 18">
