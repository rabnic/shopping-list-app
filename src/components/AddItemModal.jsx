...
import { addItem, editItem, selectShopping } from '../reducers/shoppingListSlice';
        ...
        ">
            <div className="relative w-full max-w-md max-h-full">
                ...
                <div className="relative bg-white rounded-lg shadow">
                    <button
                        type="button"
                        onClick={() => {setIsUnderEdit(false);toggleModal()}}
                    ...
                    <div className="px-6 py-6 lg:px-8">
                        <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Add New Item To Shopping List</h3>
                        <form className="space-y-6" action="#">
                            <div>
                                ...
                                <input
                                    ...
                                    type="text" name="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="e.g Brown bread" required />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    type="text" name="brand" id="brand" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="e.g Albany" required />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    type="number" name="quantity" id="quantity" placeholder="1" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required />
                            </div>
                            {/* <div>
                            ...
                            <div className="flex justify-between">
                                <div className="flex items-start">
                                    ...
                                    <label htmlFor="remember" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Don't close modal after adding item?</label>
                                </div>
                            ...
                            </div>
                            {
                                isUnderEdit ?
                                    <button
                                        ...
                                        <svg class="w-6 h-6 text-yellow-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                    ...
                                    <button
                                        type="submit"
                                        onClick={() => dispatch(addItem(shoppingItem))}
                                        className="flex items-center justify-center gap-4 tracking-wider uppercase w-full text-white bg-gray-900 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        <svg className="w-6 h-6 text-yellow-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
